...
<svelte:head>
	...
	<script src="/2048/tile.js"></script>
...
<div class="container flex flex-col items-center">
	<div class="sm:w-ft flex w-full flex-wrap items-center justify-center">
		<h1 class="title md:pr-16">2048</h1>
		<div class="w-full pb-2 md:w-fit">
			<div class="score-container mb-2 w-full px-6 pt-4 sm:mb-0 sm:w-[49%] md:w-fit">0</div>
			<div class="best-container w-full px-6 pt-4 sm:w-[49%] md:w-fit">0</div>
		</div>
	</div>

	<div class="flex flex-wrap items-center justify-center gap-3 sm:justify-normal">
		<p class="">Join the numbers and get to the <strong>2048 tile!</strong></p>
	...
	<hr />
	<p>
		Created by <a href="http://gabrielecirulli.com" target="_blank">Gabriele Cirulli.</a> Based on
